        ...
        >
          ...
          <div class="flex flex-wrap p-4 w-full overflow-hidden justify-center">
            ...
            >
              ...
              ></div>
              <div
                class="absolute z-0 w-full h-full transform scale-x-105 scale-y-95 bg-gray-900 border border-purple-800 rounded-xl transition ease-in-out duration-300 hover:scale-105 text-center"
                style={{ zIndex: "-1" }}
              >
                <h3
                ...
                <div class="z-10 p-2 justify-items-center">
                  <svg
                ...
                <div class="z-10 p-2 text-sm text-center text-gray-400 ">
                  Well this one is interesting one. Not a complex Angular
                  Project or something, but the fact this whole project is
                  developed and implemented using Termux on an Android
                  Smartphone. Beatae minima ut delectus numquam accusamus.
                </div>
              </div>
            </a>
            <a
